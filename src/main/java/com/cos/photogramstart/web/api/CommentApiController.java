...
public class CommentApiController {
	...
	public ResponseEntity<?> commentSave(@Valid @RequestBody CommentDto dto, BindingResult bindingResult, @AuthenticationPrincipal PrincipalDetails principal) {
		...
		Comment comment = commentService.writeReply(dto.getContent(), dto.getImageId(), principal.getUser().getId());
